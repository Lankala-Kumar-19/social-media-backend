...
const commentSchema = new mongoose_1.Schema({
    ...
    post: { type: mongoose_1.default.Schema.ObjectId, ref: 'Post', required: true },
    parentComment: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Comment', default: null },
}, {
    timestamps: true
});
